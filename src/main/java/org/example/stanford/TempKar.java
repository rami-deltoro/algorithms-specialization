...
public class TempKar {
    ...
    public static long karatsuba(long x, long y) {
        ...
        // Recursive case: Decompose the problem by splitting the integers and applying the algorithm on the parts.
            ...
            long        high1 = Integer.parseInt(strCopy(m2, xString)[0]); // the most significant digits. this is the scalar multiplier for b^m2
            long        low1 = Integer.parseInt(strCopy(m2, xString)[1]); // the least significant digits. this is what is added on to high1*b^m2
            long        high2 = Integer.parseInt(strCopy(m2, yString)[0]); // same for y
            long        low2 = Integer.parseInt(strCopy(m2, yString)[1]);// same for y
